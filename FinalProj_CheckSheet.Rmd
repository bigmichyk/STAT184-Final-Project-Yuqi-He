...
(A) .Rmd Line numbers where at least two different data sources are imported:  lines 25 and 33.


(B) .Rmd Line numbers for inspecting data intake:  lines 56-59 and 82-85.
...
(A) .Rmd Line number(s) for general data wrangling: lines 134-136, 173-176, 210-220, 250-253, 311-329, 352-365, 471-477.


(B) .Rmd Line number(s) for a join operation: lines 230 and 334


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent): lines 292 and 367


(D) .Rmd Line number(s) for use of regular expressions: 


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: lines 320, 356, 357, 477, 328, 329.


(F) .Rmd Line number(s) for use of user-defined functions: lines 395 and 437.


(G) .Rmd Line number(s) for use of loops and/or control flow: 


(H) .Rmd Line number(s) for use of machine learning (not "wrangling" but scored here): 470-492(supervised learning) 
...
(A) .Rmd Line number(s) for use of mulitple different geoms:  lines 297-301, 336-346, 409-422, 449-464

(B) .Rmd Line number(s) for use of multiple aesthetics:  lines 297, 337, 341, 369, 409-420, 449-462

(C) .Rmd Line number(s) for use of layered graphics:  lines 299, 371, 411-422, 451-464

(D) .Rmd Line number(s) for use of leaflet maps:  n

(E) .Rmd Line number(s) for use of decision tree or dendogram results: line 492   
