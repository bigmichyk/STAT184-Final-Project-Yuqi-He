...
(A) .Rmd Line numbers where at least two different data sources are imported:  lines 27 and 35.


(B) .Rmd Line numbers for inspecting data intake:  lines 59-62 and 84-87.
...
(A) .Rmd Line number(s) for general data wrangling: lines 136-138, 175-178, 212-222, 252-255, 313-331, 354-367, 473-479.


(B) .Rmd Line number(s) for a join operation: lines 232 and 336


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent): lines 294 and 369


(D) .Rmd Line number(s) for use of regular expressions: 


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: lines 322, 358, 359, 479, 330, 331.


(F) .Rmd Line number(s) for use of user-defined functions: lines 397 and 439.


(G) .Rmd Line number(s) for use of loops and/or control flow: 


(H) .Rmd Line number(s) for use of machine learning (not "wrangling" but scored here): 472-494(supervised learning) 
...
(A) .Rmd Line number(s) for use of mulitple different geoms:  lines 299-303, 338-348, 411-424, 451-466

(B) .Rmd Line number(s) for use of multiple aesthetics:  lines 299, 339, 343, 371, 411-422, 451-464

(C) .Rmd Line number(s) for use of layered graphics:  lines 301, 373, 413-424, 453-466

(D) .Rmd Line number(s) for use of leaflet maps:  n

(E) .Rmd Line number(s) for use of decision tree or dendogram results: line 494   
